...
public class OrderRepositoryIntegrationTest extends AbstractIntegrationTest {
	...
	static final com.oreilly.springdata.jpa.core.QProduct product = com.oreilly.springdata.jpa.core.QProduct.product;
	...
	public void createOrder() {
		...
		// or using QuerydslPredicateExecutor, productRepository.findOne(product.id.eq(1L)).get();
